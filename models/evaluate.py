...
if __name__ == '__main__':
    ...
    if run_linkbert:
        ...
        annotated_data_path = annotated_files_path_prefix + "ct_neuro_test_annotated_{}_{}.csv".format(model_name_str, "20230916")
        annotated_data_path_bio = annotated_files_path_prefix + "ct_neuro_test_annotated_{}_BIO_{}.csv".format(model_name_str, "20230916")
    ...
    if run_biobert:
        ...
        model_name_str = hugging_face_model_name.split("/")[1]
        annotated_data_path = annotated_files_path_prefix + "ct_neuro_test_annotated_{}_{}.csv".format(model_name_str,
                                                                                                       "20230916")
        annotated_data_path_bio = annotated_files_path_prefix + "ct_neuro_test_annotated_{}_BIO_{}.csv".format(
            model_name_str, "20230922")
        df = pd.read_csv(annotated_data_path)
        evaluator = ModelEvaluator(target_dataset, df, source_id_col_name="nct_id", source_sent_col_name='text',
                                   train_entities_distr_dict=train_entities_distr_dict,
                                   confidence=0.95, output_file_path=output_evaluation_path_prefix)
